...
mklink /D %APPS_HOME%\msys64\home\%USERNAME%\.vim\pythonx      %APPS_HOME%\dotvim\pythonx
mklink /D %APPS_HOME%\msys64\home\%USERNAME%\.vim\rplugin      %APPS_HOME%\dotvim\rplugin
