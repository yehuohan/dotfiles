...
local function pkg_multicursor()
    ...
    -- ,c  n  p  N  P  skip  remove
    -- ,v
    m.nnore({ ',c', function() mc.matchAddCursor(1) end })
    m.vnore({ ',v', mc.appendVisual })
    ...
    mc.addKeymapLayer(function(lyr)
        ...
        lyr({ 'n', 'x' }, 'p', function() mc.matchAddCursor(-1) end)
...
local function pkg_hlchunk()
    require('hlchunk').setup({
        ...
        indent = {
            ...
            chars = { '⁞' },
            style = { 'Gray30' },
            exclude_filetypes = { alpha = true, Popc = true, screensaver = true },
        },
...
local pkgs = {
    ...
    { 'jake-stewart/multicursor.nvim', init = pkg_multicursor, event = 'VeryLazy' },
